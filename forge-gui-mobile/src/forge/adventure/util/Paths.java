 ...
 */
public class Paths {
    public static final String ENEMIES = "enemies.json";
    public static final String SHOPS = "shops.json";
    public static final String WORLD = "world.json";
    public static final String HEROES = "world/heroes.json";
    public static final String POINTS_OF_INTEREST = "points_of_interest.json";
    public static final String ITEMS = "world/items.json";
    public static final String QUESTS = "quests.json";
